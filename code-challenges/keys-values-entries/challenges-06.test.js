...
const getHouses = arr => {
  let houseNames = [];
  arr.forEach(object => {
    houseNames.push(Object.values(object)[3])
  })
...
const hasChildrenValues = (arr, character) => {
  ...
  arr.forEach(object => {
    objArr.push(Object.values(object)[0])
  })
  let index = objArr.indexOf(character)
  let char = arr[index]
  let children = Object.values(char)
  let childrenArrLength = children[2].length;
...
const hasChildrenEntries = (arr, character) => {
  ...
  arr.forEach(obj => {
    keyValArr.push(Object.entries(obj))
  })
  let numberOfChildren = keyValArr[index][2][1].length;
